...
@Composable
fun NewExpenseScreen(vm: ViewModel, paddingValues: PaddingValues) {
    var shop by remember { mutableStateOf(TextFieldValue("")) }
        ...
        LazyColumn(
            ...
            item {
                Box(modifier = Modifier.fillMaxWidth()) {
                    ...
                    Text(
                        text = "New Expanse", style = MaterialTheme.typography.titleLarge,
            ...
            item {
                TextField(
                    ...
                    placeholder = { Text(text = "Enter a shop name!") },
                )
            }
            item {
                TextField(
                    ...
                    placeholder = { Text(text = "Enter a spent amount of money!") },
                )
            }
            item {
                Button(onClick = {
